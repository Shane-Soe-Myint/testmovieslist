    ...
    return (
        <div className="main">
            ...
            <div className="navBarContainer">
                ...
                <h1>Movies <a className="movieChangeBtn" onClick={() => showV_()} ref={movieChangeBoxRef}><img src="https://icons.veryicon.com/png/o/internet--web/industrial-icon/sort-2.png"/></a>
